...
def initialize_bot() -> None:
    ...
    # メッセージハンドラーの初期化
    message_handler = MessageHandler(bot_id, access_token)
...
def home():
    ...
    <body>
        <h1>LINE WORKS Bot 自動応答 Webhook Server</h1>
        <div class="info">
            <h2>サーバー情報</h2>
        ...
        <div class="features">
            ...
            <ul>
                <li>キーワードベースの応答</li>
                <li>正規表現パターンマッチングによる応答</li>
                <li>ユーザーごとの会話状態管理</li>
                <li>マルチステップの対話フロー
                    <ul>
                        <li>休暇申請フロー（「休暇申請」と入力）</li>
                        <li>問い合わせフロー（「問い合わせ」と入力）</li>
                    </ul>
                </li>
            </ul>
        </div>
